...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Users\shoya_kamei\benkyou\laravel-workshop-bookstore\public\storage' => 'string',
...
'app.charset','auth.defaults.guard','auth.defaults.passwords','auth.guards.web.driver','auth.guards.web.provider',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links.C:\\Users\\shoya_kamei\\benkyou\\laravel-workshop-bookstore\\public\\storage','ide-helper.filename',
...
'comics.index','users.index','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor',
...
'validation.attributes.value','validation.attributes.winner','validation.attributes.work','validation.attributes.year','ja.0',
